...
void CqShaderExecEnv::SO_bounce3d_diffuse(IqShaderData* diffusePtc,
		IqShaderData* nonDiffusePtc,
		IqShaderData* result,
		IqShader* pShader,
		TqInt cParams,
	...
	diffusePtc->GetString(fileNameDiffusePtc);
	nonDiffusePtc->GetString(fileNameNonDiffusePtc);
